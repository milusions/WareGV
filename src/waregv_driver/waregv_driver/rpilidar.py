...
class YDLidarNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('baudrate', 115200)  # Try 115200 first; change to 128000 if needed
        ...
        # Minimal configuration for YDLidar X2
    ...
    def publish_scan(self):
        ...
        if self.laser.doProcessSimple(scan_data):
            ...
            msg.ranges = [point.range for point in scan_data.points]
            msg.intensities = [point.intensity for point in scan_data.points]
