  ...
  const hardware_interface::HardwareComponentInterfaceParams & params)
{
  ...
  // Parse parameters from URDF if provided
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  hw_positions_[2]  = pos_left[1];   // Rear-Left
  hw_velocities_[2] = vel_left[1];

  hw_positions_[3]  = pos_right[1];  // Rear-Right
  hw_velocities_[3] = vel_right[1];
